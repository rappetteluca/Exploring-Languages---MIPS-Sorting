...
#Although an unconventional syntax, I'm keeping the format for iterative selection sort cascaded
#to further emphasize the point that very little modifications are done to the stack compared
#to recursive quicksort, which has 5 or 6 times the amount of operations on the stack as the iterative solution.
